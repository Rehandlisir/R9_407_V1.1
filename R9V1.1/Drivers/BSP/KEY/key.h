...
uint8_t key_scan1(void);// KEY1 - PE15 姿态1 
uint8_t key_scan2(void);// KEY2-  PE14 左转向
uint8_t key_scan3(void);// KEY3-  PE13  右转向
uint8_t key_scan4(void);// KEY4 -PE12 调速增
uint8_t key_scan5(void);// KEY5-PE11: 姿态2
